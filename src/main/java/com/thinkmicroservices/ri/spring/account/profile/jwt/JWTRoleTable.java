package com.thinkmicroservices.ri.spring.account.profile.jwt;
...
public class JWTRoleTable {
    ...
    private static final Object[][] uriRoleTable = {
        {"/profile/account/all", new String[]{"ANY"}, new String[]{ADMIN_ROLE}},
        {"/profile/account", new String[]{"ANY"},new String[]{USER_ROLE}},
        {"/profile/image", new String[]{"POST"},new String[]{USER_ROLE}}
